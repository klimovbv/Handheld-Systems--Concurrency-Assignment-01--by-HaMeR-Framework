...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!mUrlEditText.getText().toString().equals("")){
            mDefaultUrl=Uri.parse(mUrlEditText.getText().toString());
        }
    }
    ...
    protected void onActivityResult(int requestCode,
        ...
        if (resultCode==RESULT_OK) {
            ...
            if (requestCode==DOWNLOAD_IMAGE_REQUEST) {
                ...
                // file.
                // @@ TODO -- you fill in here.
                Uri uri=Uri.parse(data.getStringExtra("dataUri"));
                Log.d("result String:",uri.toString());
                Intent photoIntent=makeGalleryIntent(uri.toString());
        ...
        // code.
            ...
            Toast.makeText(this,"problem occured in this url:",Toast.LENGTH_LONG).show();
        }
    }    
    ...
    private Intent makeGalleryIntent(String pathToImageFile) {
        ...
        File photo_file = new File(pathToImageFile);
        galleryIntent.setDataAndType(Uri.fromFile(photo_file), "image/*");
